...
/**
 * GET handler for top active Slack channels
 */
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    const channels = await analyticsService.getTopActiveChannels(
      integrationId,
      limit
    );
    ...
    console.error('Error getting top active Slack channels:', error);
    return NextResponse.json(
